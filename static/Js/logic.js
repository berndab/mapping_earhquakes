...
//  Create the techtonic plate layer for the map
...
// Earthquake Data JSON Data URL.
let geoJsonEarthquakeDataURL = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson";

d3.json(geoJsonEarthquakeDataURL).then(function(data) {
	...
	// Creating a GeoJSON layer for earthquake data with the retrieved data.
  	L.geoJSON(data, {
